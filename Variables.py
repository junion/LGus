...
def change_variable(variable,values):
    """Change the values associated with a domain variable 
...
class SubDomain(Domain):
    ...
    def varinsts(self,variables=None):
        ...
        return self._varinsts(variables)
    ...
    def maxout(self,vars_togo):
        """Maxing out (marginalising) the variables vars_togo from the factor
        ...
        @rtype: L{Parameters.Factor} object
        """
        return self.copy().map_marginalise_away(vars_togo)
